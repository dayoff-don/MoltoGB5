...
<div class="T_ds_table T_ht_full U_mg_ct M_pd_Pwd6 T_pd_ht40">
    <!-- 회원정보 입력/수정 시작 { -->
    <div class="mbskin  T_ds_cell T_vt_md" id="register_member" style="max-width:640px">
        ...
        <div class="toggle">
            ...
            <span class="right_i"><i></i> <em class="T_vt_md">자세히보기</em> </span>
            <span class="title-name"><input type="checkbox" name="agree" value="1" id="agree11"> <label for="agree11">가입약관 및 개인정보처리방침안내</label></span>
            </div>
            <div class="toggle-inner U_ov_at" style="max-height:400px;">
                <p><?php echo conv_content($config['cf_stipulation'], 0); ?></p>
            </div>
        </div>  <!-- END OF TOGGLE -->
        <div class="toggle T_mg_btm10">
            <div class="toggle-title">
            <span class="right_i"><i></i> <em class="T_vt_md">자세히보기</em> </span>
            <span class="title-name"><input type="checkbox" name="agree2" value="1" id="agree21"> <label for="agree21">추가안내 및 주의사항</label></span>
            </div>
            <div class="toggle-inner U_ov_at" style="max-height:400px;">
        ...
        <div class="U_bd_all01 T_pd_ht20 T_pd_Pwd2" style="border-color:#c6cacc">
            <label for="reg_mb_email" class="sound_only">E-mail<strong class="sound_only">필수</strong></label>
            <input type="text" name="mb_email" value="<?php echo isset($user_email)?$user_email:''; ?>" <?php echo isset($user_email)?'readonly':''; ?> id="reg_mb_email" required class="frm_input email required T_wd_full" size="70" maxlength="100" placeholder="이메일을 입력해주세요." >
            <label for="mb_1" class="sound_only"> 깃허브 네임<strong class="sound_only">필수</strong></label>
            <input type="text" name="mb_1" id="mb_1" required class="frm_input  T_mg_ht10 T_wd_full required" size="70" maxlength="100" placeholder="깃허브 네임을 입력해주세요." >
            <label for="mb_hp" class="sound_only">연락처</label>
            <input type="text" name="mb_hp" id="mb_hp" required class="frm_input T_wd_full required" size="70" maxlength="100" placeholder="연락처를 입력해주세요." >
        </div>
            <div class="T_ft_ct T_mg_top30 ">
                <input type="submit" value="회원가입" accesskey="s" class="T_pd_ht15 PT_pd_wd60 U_bd_rd PT_ft_sz18 M_ft_rem13hf sir_bg01 sir_bd01 U_ft_cfff M_wd_full">
            </div>
        </form>
        <!-- 새로가입 끝 -->
        ...
        */?>
        ...
        {
            if (!f.agree.checked) {
                alert("가입약관 및 개인정보처리방침안내에 동의하셔야 회원가입 하실 수 있습니다.");
                f.agree.focus();
                return false;
            }

            if (!f.agree2.checked) {
                alert("추가안내 및 주의사항에 동의하셔야 회원가입 하실 수 있습니다.");
                f.agree2.focus();
                return false;
            }
